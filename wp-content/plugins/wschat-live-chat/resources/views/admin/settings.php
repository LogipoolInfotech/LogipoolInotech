...
<div class="elex-wschat-note p-3 mb-2">
	<h6 class="mb-0">You need to <a href="#">setup Pusher</a> to start using WSchat.  <a target="_blank" href="https://pusher.com/">Create a free Pusher Account</a></h6>
</div>
		...
		<?php foreach ( $menus as $menu_item ) { ?>
			<li class="nav-item">
				...
				?>
					"
				>
					<span><?php echo esc_attr( $menu_item['title'] ); ?></span><?php if ( 'restrictions' === $menu_item['slug'] ) { ?>
									<sup class="elex_wschat_go_premium_color"><?php esc_html_e( '[Premium]', 'elex-abandoned-cart' ); ?></sup>
									<?php } ?>
				</a>
			</li>
		<?php } ?>
