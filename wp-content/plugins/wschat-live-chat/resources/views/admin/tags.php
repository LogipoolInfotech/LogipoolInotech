								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="input-group input-group-sm mb-3">
											...
											<input type="date" max="<?php echo esc_attr( gmdate( 'Y-m-d' ) ); ?>" value="<?php echo isset( $created_at['min'] ) ? esc_html( get_date_from_gmt( $created_at['min'], 'Y-m-d' ) ) : '' ; ?>" name="created_at[min]" class="form-control form-control-sm" aria-describedby="from date">
									...
									<div class="col-md-6">
										...
										<div class="input-group input-group-sm mb-3">
											...
											<input type="date" max="<?php echo esc_attr( gmdate( 'Y-m-d' ) ); ?>" value="<?php echo isset( $max_date ) ? esc_html( date_create( $max_date )->format( 'Y-m-d' ) ) : '' ; ?>" name="created_at[max]" class="form-control form-control-sm" aria-describedby="to date">
										</div>
									</div>
								</div>
							</div>
										...
										<div class="d-flex gap-2 flex-wrap my-2">
											...
											if ( isset( $message['body']['attachments'] ) ) {
												foreach ( $message['body']['attachments'] as $file ) {
													...
													<?php } elseif ( 'application/pdf' === $file['type'] ) { ?>
														<svg xmlns="http://www.w3.org/2000/svg" width="13" viewBox="0 0 384 512">
													...
													<?php } elseif ( 'application/javascript' === $file['type'] ) { ?>
													...
													<?php } elseif ( 'application/x-gzip' === $file['type'] || 'application/rar' === $file['type'] || 'application/x-7z-compressed' === $file['type'] ) { ?>
														<svg xmlns="http://www.w3.org/2000/svg" width="13" viewBox="0 0 384 512">
													...
													<?php } elseif ( 'application/msword' === $file['type'] ) { ?>
														<svg xmlns="http://www.w3.org/2000/svg" width="13" viewBox="0 0 384 512">
													...
													<?php } elseif ( "'application/vnd.ms-powerpoint'" === $file['type'] ) { ?>
														<svg xmlns="http://www.w3.org/2000/svg" width="13" viewBox="0 0 384 512">
													...
													<?php } elseif ( "'application/vnd.ms-excel'" === $file['type'] ) { ?>
														<svg xmlns="http://www.w3.org/2000/svg" width="13" viewBox="0 0 384 512">
