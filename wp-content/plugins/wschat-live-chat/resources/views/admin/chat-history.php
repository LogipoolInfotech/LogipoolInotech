	...
	<div class="d-none no-conversation-alert alert alert-warning m-1">
		...
		<div class="p-2 d-flex gap-3 vh-95">
			...
			<!-- ================side panel=============== -->
			<div class="elex-ws-chat-side-panel h-100 bg-white d-none">
				<div class="rounded-3 primary-shadow overflow-hidden h-100">
					<div class="wschat-bg-primary d-flex gap-2 p-2 align-items-center ">
						...
						<div class="wschat-text-primary">
							...
							<div class="btn-group">
								<button type="button" class="btn btn-sm btn-priamry border-white rounded-pill wschat-text-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
									<?php esc_html_e( 'Online', 'wschat' ); ?>
								</button>
								<ul class="dropdown-menu">
									<li class=" position-relative">
										<a class="dropdown-item" href="#">
											<span class="badge me-2 p-1  rounded-circle bg-success">
									  ...
									  <li class="">
										<a class="dropdown-item" href="#">
										<span class="badge me-2 p-1 rounded-circle bg-secondary">
									  ...
									  <li class="">
										<a class="dropdown-item" href="#">
										<span class="badge me-2 p-1 rounded-circle bg-danger">
					...
					<div class="shadow-sm rounded-3 m-2 mb-3 d-flex ">
						...
						<div class="input-group input-group-sm search-box">
							<input type="text" name="search-control" class="form-control border-0" placeholder="<?php esc_html_e( 'Search Tag' ); ?>">
						</div>
					</div>
			...
			<div class="elex-ws-chat-main-content h-100 flex-fill position-relative bg-white">
				<div class="rounded-3 primary-shadow overflow-hidden h-100 d-flex flex-column">
					...
					<div class="wschat-bg-primary d-flex justify-content-between p-2 align-items-center chat-panel-header">
						<div class="d-flex gap-2 align-items-center">
							...
							<div class="wschat-text-primary">
								<h6><span class="username wschat-text-primary"></span> <span class="elex-ws-chat-contact-unread-message unread-count badge rounded-pill d-none"></span></h6>

								<div class="d-flex align-items-center gap-1">
									<span class="badge p-1 d-block rounded-circle status"></span><small></small>
								</div>
							</div>
						</div>
						<div class="d-flex gap-2 conversation-header-actions">
							...
							<!-- Back button -->
							<button onclick="history.back()" class="btn btn-sm rounded border elex-wschat-back-btn">
									&#x3C; <?php esc_attr_e( 'Back' ); ?>
							</button>
					...
					<!-- chat box main -->
					<div
						class="d-flex elex-ws-chat-convo-body flex-column flex-fill justify-content-lg-end  position-relative mb-5">
					...
					<div class="bg-light p-2 position-relative chat-box-footer">
						<!--attach file -->
						<div class="p-2 elex-ws-chat-convo-attach-file d-none">
						...
						<div class="d-flex gap-2 align-items-center position-relative d-none">
							<!-- other types input -->
							...
							<button class="icon-btn " id="wschat_emoji_picker">
								<svg class="wschat-icon-color" xmlns="http://www.w3.org/2000/svg " width="16 " height="16 " viewBox="0 0 24 24 ">
							...
							<!-- send button -->
							<button class="icon-btn " id="wschat_send_message">
								<svg class="wschat-icon-color" xmlns="http://www.w3.org/2000/svg " width="16 " height="16 "
