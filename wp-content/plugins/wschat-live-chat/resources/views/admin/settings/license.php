				...
				<div class="row">
					...
					<div class="panel panel-default p-3 col-12" style="background:white ">
						<div class="panel-heading">
							<h3 class="panel-title mb-3" style="text-align:center;background: #337ab7;color: white;"><?php esc_html_e( 'ELEXtensions Plugins You May Be Interested In' ); ?></h3>
						</div>
						<div class="panel-body">
							<div class="row">
								...
								<div class="col-md-4" style="text-align:center">
									...
									<div class="row">
										<div class="col-md-12">
											<h5><a href="https://elextensions.com/plugin/bulk-edit-products-prices-attributes-for-woocommerce/?utm_source=plugin-settings-related&utm_medium=wp-admin&utm_campaign=in-prod-ads" data-wpel-link="internal" target="_blank">ELEX Bulk Edit Products, Prices &amp; Attributes for WooCommerce</a></h5>
										</div>
									</div>
								</div>
								<div class="col-md-4" style="text-align:center">
									...
									<div class="row">
										<div class="col-md-12">
											<h5><a href="https://elextensions.com/plugin/woocommerce-google-product-feed-plugin/?utm_source=plugin-settings-related&utm_medium=wp-admin&utm_campaign=in-prod-ads" data-wpel-link="internal" target="_blank">ELEX WooCommerce Google Product Feed Plugin</a></h5>
										</div>
									</div>
								</div>
								<div class="col-md-4" style="text-align:center">
									...
									<div class="row">
										<div class="col-md-12">
											<h5><a href="https://elextensions.com/plugin/woocommerce-catalog-mode-wholesale-role-based-pricing/?utm_source=plugin-settings-related&utm_medium=wp-admin&utm_campaign=in-prod-ads" data-wpel-link="internal" target="_blank">ELEX WooCommerce Catalog Mode, Wholesale &amp; Role Based Pricing</a></h5>
										</div>
									</div>
								</div>
